 ...
 * Gravity!
 *
 * Lets see if i can remember the gravity equasion with multiple masses...
 */
...
var ENGINE = {
  ...
  init: function() {
    ...
    // Set some default fixtures
    //Stars
    this.entities.push(new Entity(100, 100, 50));
    this.entities.push(new Entity(400, 100, 5, 0, 0, false));
...
var Entity = function(x, y, mass, vx, vy, static) {
  this.x = x;
  this.y = y;
  this.mass = mass;
  this.vx = vx || 0;
...
Entity.prototype = {
  ...
  draw: function(context) {
    ...
    Helper.circle(context, this.mass, p(this.x, this.y), 'orange');
  },
};
/*
...
var Helper = {
  ...
  gravity_force: function(entity1, entity2) {
